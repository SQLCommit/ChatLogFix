...
$fixture = @'
<div align="center">
# ![ChatLogFix](https://readme-typing-svg.demolab.com/?lines=ChatLogFix)
...
| `/chatlogfix limit <rate>` | `/ashita/<Name>_<id>/` |
...
foreach ($expected in @(
    '# ChatLogFix', '## Features', '### Cutscenes', 'Keep this summary.',
...
$scratch = Join-Path ([IO.Path]::GetTempPath()) ('chatlogfix-release-test-' + [guid]::NewGuid().ToString('N'))
